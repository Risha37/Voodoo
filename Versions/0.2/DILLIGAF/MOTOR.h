...
#define LeftMotorPwm  0   // left motor pwm (? output)
#define RightMotorPwm 0   // right motor pwm (? output)
#define LeftMotorEnable 0   // left motor enable (? output)
#define RightMotorEnable  0   // right motor enable (? output)
